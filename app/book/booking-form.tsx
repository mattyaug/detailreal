  ...
  return (
    <section className="shell booking-layout">
      <aside className="booking-summary">
        <span className="eyebrow">Your detail</span>
        <h2>{service.name}</h2>
        ...
        <div className="info-box">Final price can vary by vehicle size and condition. Update the starter pricing in <code>lib/services.ts</code> before launch.</div>
      </aside>
      ...
      <form className="form-card" onSubmit={submit}>
        ...
        <div className="form-grid">
          ...
          <div className="field full">
            ...
            <input id="date" name="date" className="input" type="date" min={todayString()} value={date} onChange={(e) => setDate(e.target.value)} required />
          </div>
          <div className="field full">
